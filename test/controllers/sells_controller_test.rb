...
class SellsControllerTest < ActionController::TestCase
  ...
  test "should create sell" do
    assert_difference('Sell.count') do
      post :create, sell: { cantidad: @sell.cantidad, precio_total: @sell.precio_total, product_id: @sell.product_id }
    end
  ...
  test "should update sell" do
    patch :update, id: @sell, sell: { cantidad: @sell.cantidad, precio_total: @sell.precio_total, product_id: @sell.product_id }
    assert_redirected_to sell_path(assigns(:sell))
  end
